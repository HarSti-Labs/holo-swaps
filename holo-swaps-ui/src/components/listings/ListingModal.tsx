      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl w-full max-w-lg flex flex-col shadow-2xl">
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            ...
            />
            <p className="text-xs text-slate-400 text-right mt-0.5">{description.length}/500</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-5 border-t border-slate-700">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="px-5 py-2 bg-green-600 hover:bg-green-500 disabled:bg-slate-700 disabled:text-slate-400 disabled:cursor-not-allowed text-white rounded-lg font-medium text-sm transition-colors"
            >
              {isSaving
                ? "Saving..."
                : item.isOpenListing
